...
import { resolvePearlHeroMedia } from "../../../../../src/core/media/pearl";
...
export default async function PearlCandidatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const resolvedMedia = await resolvePearlHeroMedia(candidate.direction);
  const heroMedia = resolvedMedia ? { src: resolvedMedia.imageUrl, alt: resolvedMedia.alt, focalPoint: resolvedMedia.focalPoint } : undefined;
