...
export default async function PearlCandidatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const plannedHeroMedia = usePlannedHeroMedia ? heroMedia : undefined;
  ...
  const hero = sections.hero === "hero-cinematic-fullscreen" ? <CinematicFullscreenHero {...heroProps} secondaryCta={secondaryHeroCta} media={heroMedia} visualLabel={candidate.direction.label} /> : sections.hero === "hero-typography-led" ? <TypographyLedHero {...heroProps} accent="Pearl" media={plannedHeroMedia} /> : sections.hero === "hero-conversion-split" ? <ConversionSplitHero {...heroProps} secondaryCta={secondaryHeroCta} media={heroMedia} proof={["Hyderabad", "Clear next steps", "Patient-friendly information"]} /> : sections.hero === "hero-framed-statement" ? <FramedStatementHero {...heroProps} secondaryCta={secondaryHeroCta} media={plannedHeroMedia} /> : sections.hero === "hero-poster-offset" ? <PosterOffsetHero {...heroProps} secondaryCta={secondaryHeroCta} media={plannedHeroMedia} /> : <EditorialSplitHero brand={brand} {...heroProps} secondaryCta={secondaryHeroCta} trustItems={[{label:"Hyderabad"},{label:"Clear next steps"},{label:"Patient-friendly information"}]} visualNote={narrative.about.headline} media={heroMedia} />;
