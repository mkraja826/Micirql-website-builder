...
export function AiEditVisualPreview({ site, pageId, sectionId, operation, viewport: initialViewport = "desktop" }: { site: Site; pageId: string; sectionId?: string; operation: AiEditorOperation; viewport?: EditorViewport }) {
  const frame = useRef<HTMLDivElement>(null);
  const [viewport, setViewport] = useState<EditorViewport>(initialViewport);
