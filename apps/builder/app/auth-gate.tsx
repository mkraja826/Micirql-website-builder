...
.auth-card>div:first-child{display:grid;gap:14px}.auth-brand-logo{display:block;width:min(100%,250px);height:auto;border-radius:12px;background:#fff}.auth-card h1{margin:0;max-width:12ch;font-size:clamp(2rem,8vw,3rem);line-height:1;letter-spacing:-.045em}
...
@media(max-width:520px){.auth-shell{place-items:start stretch;padding:max(20px,env(safe-area-inset-top)) 16px 24px}.auth-card{margin-top:7svh;width:100%;padding:22px;border-radius:18px}.auth-card h1{max-width:10ch;font-size:clamp(2.15rem,11vw,3rem)}.auth-brand-logo{width:min(100%,230px)}}
`;
