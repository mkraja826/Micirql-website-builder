...
import "@micirql/sections/interaction-polish.css";
...
import "@micirql/sections/dental-08-boutique-cosmetic-refinement.css";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en">
      <body><PreviewInteractionGuard /><KeyboardSectionActions /><KeyboardShortcutsHelp /><CanvasMultiSelect /><BatchSectionActions />{children}</body>
    </html>
  );
}
