...
export function StructuralServices(props: VariantProps) {
  ...
  const anchor = props.sectionAnchor ? { id: props.sectionAnchor } : {};
  if (props.variant === 2) return <section {...anchor} className="mi-section mi-services mi-services--list"><Container><div className="mi-services-split"><Heading {...props} /><div className="mi-services-list">{items.map((item, index) => <ServiceItem key={`${item.title}-${index}`} item={item} index={index} numbered />)}</div></div><Actions {...props} /></Container></section>;
  if (props.variant === 3) return <section {...anchor} className="mi-section mi-services mi-services--spotlight"><Container><Heading {...props} /><div className="mi-services-spotlight">{items.map((item, index) => <ServiceItem key={`${item.title}-${index}`} item={item} index={index} />)}</div><Actions {...props} /></Container></section>;
  if (props.variant === 4) return <section {...anchor} className="mi-section mi-services mi-services--editorial"><Container><div className="mi-services-editorial-head"><Heading {...props} /><Actions {...props} /></div><div className="mi-services-editorial-grid">{items.map((item, index) => <ServiceItem key={`${item.title}-${index}`} item={item} index={index} numbered />)}</div></Container></section>;
  if (props.variant === 5) return <section {...anchor} className="mi-section mi-services mi-services--band"><Container><div className="mi-services-band-head"><Heading {...props} /></div><div className="mi-services-band-grid">{items.map((item, index) => <ServiceItem key={`${item.title}-${index}`} item={item} index={index} />)}</div><Actions {...props} /></Container></section>;
  return <section {...anchor} className="mi-section mi-services mi-services--cards"><Container><Stack gap="xl"><Heading {...props} /><div className="mi-services-card-grid">{items.map((item, index) => <ServiceItem key={`${item.title}-${index}`} item={item} index={index} />)}</div><Actions {...props} /></Stack></Container></section>;
}
