...
export function StructuralFooter(props: VariantProps) {
  ...
  if (props.variant === 4) return <footer className="mi-shell-footer mi-shell-footer--contact"><Container><div>{brand}<PrimaryAction action={props.primaryAction} /></div>{links}<div className="mi-footer-legal">{copyright}</div></Container></footer>;
