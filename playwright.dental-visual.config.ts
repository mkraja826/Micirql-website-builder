...
export default defineConfig({
  ...
  webServer: [
    {
      command: "NEXT_PUBLIC_SUPABASE_URL=http://localhost:54321 NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY=test-key MICIRQL_DRAFT_STORE=supabase MICIRQL_QA_RENDER_CERTIFIER=1 pnpm --filter @micirql/builder dev",
