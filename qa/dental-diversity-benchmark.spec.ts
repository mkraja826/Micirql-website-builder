...
const scenarios: Array<{ id: string; expectedLayout: string; expectedIntent: CompositionIntent; profile: OnboardingProfile }> = [
  ...
  { id: "restorative", expectedLayout: "dental-19-minimal-white", expectedIntent: "showcase", profile: { industry: "dental clinic", subindustry: "restorative dentistry", goals: ["build credibility", "book consultations"], style_tags: ["premium", "calm"], required_capabilities: ["booking", "gallery"], services: ["crowns", "bridges", "full mouth rehabilitation"] } },
