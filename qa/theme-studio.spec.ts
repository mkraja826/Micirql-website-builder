...
test("density shape and motion are exposed as one named control group", () => {
  expect(themeStudio).toContain('className={styles.controls} role="group" aria-label="Layout and motion controls"');
});
