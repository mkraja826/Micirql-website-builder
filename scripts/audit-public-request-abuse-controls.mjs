...
const checks = [
  ...
  [migration.includes("length(p_name) > 120") && migration.includes("length(trim(p_email)) > 254") && migration.includes("length(trim(p_phone)) > 32"), "contact inputs must have server-side limits"],
