...
export function StatementLedgerAbout({ eyebrow, headline, body, principles }: { eyebrow?: string; headline: string; body: string; principles: Principle[] }) {
  return (
    <section style={{ padding: "var(--theme-section-y) 24px", background: "var(--theme-bg)", color: "var(--theme-text)" }}>
      <div style={{ width: "min(var(--theme-max-width), 100%)", margin: "0 auto", display: "grid", gridTemplateColumns: "minmax(0, .75fr) minmax(0, 1.25fr)", gap: "clamp(42px, 9vw, 140px)" }}>
        <div style={{ position: "relative" }}>
          ...
          <h2 style={{ margin: "0 0 24px", fontFamily: "var(--theme-display-font)", fontSize: "clamp(48px, 7vw, 88px)", lineHeight: .9, letterSpacing: "-.05em" }}>{headline}</h2>
