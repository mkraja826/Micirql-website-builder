-- Match SECURITY DEFINER certified-site persistence to the existing site write roles.
...
begin
  ...
  if not exists (
    ...
    raise exception 'actor lacks site write access in the target workspace';
  end if;
